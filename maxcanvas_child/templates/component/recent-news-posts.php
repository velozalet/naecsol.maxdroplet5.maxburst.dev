...
if($number_of_posts_to_display){ //for "Home Page"
...
}elseif( get_queried_object_id() == 60 ){  //for "News Page"
	$number_of_posts_to_display = -1;
}else{ //for "Single News Page"
	$number_of_posts_to_display = 3;
}
$recent_news_posts = get_needs_posts('post', $number_of_posts_to_display, $news_cat_ID, '', 'date', 'DESC');
?>

<? if( get_queried_object_id() == 60):?>
<?php $recent_news_posts = get_needs_posts('post', $number_of_posts_to_display, $news_cat_ID, '', 'date', 'ASC'); ?>
